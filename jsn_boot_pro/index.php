...
<html lang="<?php echo ($this->language === '*') ? JFactory::getConfig()->get('language') : $this->language; ?>" dir="<?php echo $this->direction; ?>">
<head>
	...
	?>
				...
				<div id="jsn-sitetoolspanel" class="<?php echo ($this->colorSelector)?'jsn-include-color':''; ?> pull-right">
					<ul id="jsn-sitetools-<?php echo $this->sitetoolStyle; ?>">
						...
						<a href="javascript:void(0)"></a>
							<ul>
								<li class="clearafter jsn-selector-color <?php echo "jsn-color".count($this->templateColors); ?>">
					<?php
		...
		<?php
			foreach ($this->mainColumns AS $id => $class) {
				if ($id == 'content') {
		?>
					<div id="jsn-maincontent" class="<?php echo $class['span']; ?> <?php echo $class['order']; ?> <?php echo $class['offset']; ?>"><div id="jsn-maincontent_inner" class="row-fluid">
		<?php
		...
		?>
				<div id="jsn-usermodules3" class="jsn-modulescontainer jsn-modulescontainer<?php echo $this->helper->countPositions('user5', 'user6', 'user7'); ?> row-fluid"><div id="jsn-usermodules3-inner1"><div id="jsn-usermodules3-inner">
		<?php
