<?php
/**
 * @version		$Id: item.php 16993 2012-10-13 08:03:25Z tuyetvt $
 * @package		K2
...
<div id="k2Container" class="itemView<?php echo ($this->item->featured) ? ' itemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>"
	...
	<div class="itemHeader">
		...
		<div class="jsn-article-toolbar">
			...
			<div class="jsn-article-info">
				...
				<!-- Item Author -->
				<p class="author" itemprop="author" itemscope itemtype="https://schema.org/Person"> <span class="itemAuthor"> <?php echo K2HelperUtilities::writtenBy($this->item->author->profile->gender); ?>&nbsp;
					<?php if(empty($this->item->created_by_alias)): ?>
					<a rel="author" href="<?php echo $this->item->author->link; ?>" itemprop="name"><?php echo $this->item->author->name; ?></a>
					<?php else: ?>
	...
	<div class="itemBody"> 
		...
		<!-- Item fulltext -->
		<div class="itemFullText" itemprop="articleBody"> <?php echo $this->item->fulltext; ?> </div>
		<?php endif; ?>
		<?php else: ?>
		<!-- Item text -->
		<div class="itemFullText" itemprop="articleBody"> <?php echo $this->item->introtext; ?>
			<div class="clr"></div>
		</div>
		<?php endif; ?>
